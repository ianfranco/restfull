 ...
 */
@Entity
@Table(name = "egreso_proceso_recaudacion")
@XmlRootElement
@NamedQueries({
...
public class EgresoProcesoRecaudacion implements Serializable {
    ...
    public String toString() {
        return "com.areatecnica.sigf.rest.entities.EgresoProcesoRecaudacion[ egresoProcesoRecaudacionId=" + egresoProcesoRecaudacionId + " ]";
    }
