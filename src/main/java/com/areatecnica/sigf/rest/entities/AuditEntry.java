...
public class AuditEntry implements Serializable {
    ...
    private Collection<AuditField> auditFieldCollection;
    ...
    @XmlTransient
    public Collection<AuditField> getAuditFieldCollection() {
        return auditFieldCollection;
    }

    public void setAuditFieldCollection(Collection<AuditField> auditFieldCollection) {
        this.auditFieldCollection = auditFieldCollection;
    }
    ...
    public String toString() {
        return "com.areatecnica.sigf.rest.entities.AuditEntry[ id=" + id + " ]";
    }
