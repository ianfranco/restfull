 ...
 */
@Entity
@Table(name = "detalle_resumen_recaudacion")
@XmlRootElement
@NamedQueries({
...
public class DetalleResumenRecaudacion implements Serializable {
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "detalle_resumen_recaudacion_20000")
    private int detalleResumenRecaudacion20000;
    @Basic(optional = false)
    @NotNull
    @Column(name = "detalle_resumen_recaudacion_10000")
    private int detalleResumenRecaudacion10000;
    @Basic(optional = false)
    @NotNull
    @Column(name = "detalle_resumen_recaudacion_5000")
    private int detalleResumenRecaudacion5000;
    @Basic(optional = false)
    @NotNull
    @Column(name = "detalle_resumen_recaudacion_2000")
    private int detalleResumenRecaudacion2000;
    @Basic(optional = false)
    @NotNull
    @Column(name = "detalle_resumen_recaudacion_1000")
    private int detalleResumenRecaudacion1000;
    @Basic(optional = false)
    @NotNull
    @Column(name = "detalle_resumen_recaudacion_500")
    private int detalleResumenRecaudacion500;
    @Basic(optional = false)
    @NotNull
    @Column(name = "detalle_resumen_recaudacion_100")
    private int detalleResumenRecaudacion100;
    @Basic(optional = false)
    @NotNull
    @Column(name = "detalle_resumen_recaudacion_50")
    private int detalleResumenRecaudacion50;
    @Basic(optional = false)
    @NotNull
    @Column(name = "detalle_resumen_recaudacion_10")
    private int detalleResumenRecaudacion10;
    @JoinColumn(name = "detalle_resumen_recaudacion_id_resumen", referencedColumnName = "resumen_recaudacion_id")
    ...
    public String toString() {
        return "com.areatecnica.sigf.rest.entities.DetalleResumenRecaudacion[ detalleResumenRecaudacionId=" + detalleResumenRecaudacionId + " ]";
    }
