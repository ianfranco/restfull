...
public class RecaudacionGuia implements Serializable {
    ...
    @NotNull
    @Column(name = "recaudacion_guia_id")
    private Integer recaudacionGuiaId;
    @Basic(optional = false)
    @NotNull
    @Column(name = "recaudacion_guia_monto")
    private int recaudacionGuiaMonto;
    @JoinColumn(name = "recaudacion_guia_id_egreso", referencedColumnName = "egreso_id")
    @ManyToOne(optional = false)
    private Egreso recaudacionGuiaIdEgreso;
    @JoinColumn(name = "recaudacion_guia_id_guia", referencedColumnName = "guia_id")
    @ManyToOne(optional = false)
    private Guia recaudacionGuiaIdGuia;
    @JoinColumn(name = "recaudacion_guia_id_recaudacion", referencedColumnName = "recaudacion_id")
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "com.areatecnica.sigf.rest.entities.RecaudacionGuia[ recaudacionGuiaId=" + recaudacionGuiaId + " ]";
    }
