...
import com.areatecnica.sigf.rest.entities.MetodoPago;
 ...
 */
@Stateless
@Path("com.areatecnica.sigf.rest.entities.metodopago")
public class MetodoPagoFacadeREST extends AbstractFacade<MetodoPago> {

    @PersistenceContext(unitName = "com.areatecnica.sigf_SIGFRest_war_1.0PU")
    private EntityManager em;

    public MetodoPagoFacadeREST() {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, MetodoPago entity) {
        super.edit(entity);
    }
