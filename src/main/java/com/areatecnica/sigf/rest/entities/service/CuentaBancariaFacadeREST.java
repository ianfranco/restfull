...
import com.areatecnica.sigf.rest.entities.CuentaBancaria;
 ...
 */
@Stateless
@Path("com.areatecnica.sigf.rest.entities.cuentabancaria")
public class CuentaBancariaFacadeREST extends AbstractFacade<CuentaBancaria> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, CuentaBancaria entity) {
        super.edit(entity);
    }
    ...
    public CuentaBancaria find(@PathParam("id") Integer id) {
