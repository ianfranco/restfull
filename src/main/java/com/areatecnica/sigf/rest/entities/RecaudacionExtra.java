...
public class RecaudacionExtra implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 255)
    @Column(name = "recaudacion_extra_descripcion")
    private String recaudacionExtraDescripcion;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 255)
    @Column(name = "recaudacion_extra_usuario")
    ...
    public String toString() {
        return "com.areatecnica.sigf.rest.entities.RecaudacionExtra[ recaudacionExtraId=" + recaudacionExtraId + " ]";
    }
