...
public class RecaudacionDescuentoExtra implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Basic(optional = false)
    @Column(name = "recaudacion_descuento_extra_id")
    private Integer recaudacionDescuentoExtraId;
    @JoinColumn(name = "recaudacion_descuento_extra_id_dcto", referencedColumnName = "descuento_extra_bus_id")
    @ManyToOne(optional = false)
    private DescuentoExtraBus recaudacionDescuentoExtraIdDcto;
    @JoinColumn(name = "recaudacion_descuento_extra_id_recaudacion", referencedColumnName = "recaudacion_id")
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "com.areatecnica.sigf.rest.entities.RecaudacionDescuentoExtra[ recaudacionDescuentoExtraId=" + recaudacionDescuentoExtraId + " ]";
    }
